...
function Dashboard({ setIsLoggedIn, user }) {
    ...
    const fetchPanCards = async () => {
        try {
            const response = await axios.get("https://inventoryapp-backend-yam1.onrender.com/viewPanCards", {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editId) {
                await axios.put(`https://inventoryapp-backend-yam1.onrender.com/editPanCard/${editId}`, payload);
                toast.success("PAN Card Updated Successfully");
            } else {
                await axios.post("https://inventoryapp-backend-yam1.onrender.com/addPanCard", payload);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Are you sure you want to delete this PAN card?")) {
            try {
                await axios.delete(`https://inventoryapp-backend-yam1.onrender.com/deletePanCard/${id}`);
